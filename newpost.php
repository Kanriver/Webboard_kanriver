            ...
            <div class="card border-info">
                ...
                <div class="card-body">
                    <form action="newpost_save.php" method="post">
                        ...
                        <div class="row mt-3">
                            <label for="name" class="col-lg-3 col-form-label">หัวข้อ :</label>
                            <div class="col-lg-9">
                                <input id="name" type="text" name="topic" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <label for="name" class="col-lg-3 col-form-label">เนื้อหา :</label>
                            <div class="col-lg-9">
