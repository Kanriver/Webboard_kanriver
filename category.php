...
<head>
    ...
    <title style="text-align: center; font-size: 54px;">WebBoard GoodGame</title>
</head>
<body>
<div class="container-lg">
    <h1 style="text-align: center;font-size: 54px;"class="mt-3">WebBoard GoodGame</h1>
    ...
    <script>
        function myFunction(){
                let r=confirm("คุณต้องการลบใช่ไหม?");
                return r;
            }
    </script>
</body>
